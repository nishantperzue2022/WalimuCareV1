...
{
    public class EditDependantViewModel : AppViewModel
    {
        ...
        public Member MemberSelected
        {
            ...
            set { memberSelected = value; OnPropertyChanged(); }
        }
        ...
        public string NationalIdOrBirthCertificateNumber
        {
            ...
            set { nationalIdOrBirthCertificateNumber = value;
                OnPropertyChanged();
            }
        }
        ...
        public bool IsProofOfSchoolingVisible
        {
            ...
            set { isProofOfSchoolingVisible = value;
                OnPropertyChanged();
            }
        }
        ...
        public bool IsProofOfDisabilityVisible
        {
            ...
            set { isProofOfDisabilityVisible = value;
                OnPropertyChanged();
            }
        }
            ...
            try
            {
                if (await CheckInternetConnectivity())
                {
                    if (await CheckIfApiDetailsAreSetUp())
                    {
                        ...
                        {
                            Method = Method.POST,
                            Resource = "/Members/EditMemberDepedants"
                        };

                        EditMemberDetailsBody addDependantMember = new EditMemberDetailsBody()
                        {
                            id = DependantId,
                            fullName = FullName,
                            gender = Gender,
                        ...
                        //restRequest.AddQueryParameter("depedantId", DependantId);
                        ...
                        try
                        {
                            ...
                            {
                                var serializedResponse = JsonConvert.DeserializeObject<BaseResponse<bool>>(response.Content);
                                ...
                                if (serializedResponse.success)
                                {
                                    ...
                                    await ShowSuccessMessage("Dependant Details Updated successfully");
        ...
        public void SetDetailsToBeEdited()
        {
            try
            {

                MemberSelected = DependencyService.Get<ManageDependantsViewModel>().SelectedDependant;


                Relationship = null;
                FullName = MemberSelected.FullName;
                DateOfBirth = MemberSelected.DateOfBirth.Value;
                Gender = MemberSelected.Gender;
                Relationship = MemberSelected.Relationship.Trim();
                NationalIdOrBirthCertificateNumber = MemberSelected.IdNumber;
                PhoneNumberDependant = MemberSelected.AddressMobileNumber;
                EmailDependant = MemberSelected.AddressEmail;
                MemberNumber = MemberSelected.MemberNumber;
                DependantId = MemberSelected.Id;
                //IsDisabled
            ...
            {
                SendErrorMessageToAppCenter(ex, "Edit Dependants");
            }
        }
    }
}
