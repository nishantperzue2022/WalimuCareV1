...
{
    public class WoteBuyMedicalCoverViewModel : AppViewModel
    {
        ...
        public WoteBuyMedicalCoverViewModel()
        {
        ...
        public async Task ShowNextOfKin()
        {
            try
            {
                await Shell.Current.GoToAsync(nameof(WoteNextOfKinDetailsPage));
            }
            catch (Exception ex)
            {
        ...
        private async Task UploadDocumentsPage()
        {
            try
            {
                ...
                if (result)
                {
                    await Shell.Current.GoToAsync(nameof(UploadWoteDocuments));
                }
