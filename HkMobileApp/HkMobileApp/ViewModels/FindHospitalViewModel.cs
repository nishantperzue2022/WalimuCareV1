...
namespace HkMobileApp.ViewModels
{
    public class FindHospitalViewModel : AppViewModel
    {
        ...
        public bool ProceedWithoutEnablingLocationPermission
        {
            ...
            set { proceedWithoutEnablingLocationPermission = value; OnPropertyChanged(); }
        }
        ...
        private async void SetUpFindHospitalViewModel()
        {
            try
            {
                ...
                await MoveOnMap(CurrentLocation, 5);
        ...
        public async Task ShowSelectCountyOrSpecialityPage()
        {
            try
            {
                ...
                //await App.Current.MainPage.Navigation.PushAsync(new SelectCountyOrSpeciality());
            }
            catch (Exception ex)
            {
                await ShowErrorMessage();
